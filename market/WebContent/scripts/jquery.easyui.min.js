...
//add by  2016-02-20
var tr = opts.finder.getTr(_7a3, _7a6, "body", (_7a5 ? 1 : 2));
...
//add by  2016-02-20
var oldColObj = tr.find("td[field='" + _7a9 + "']"), oldColspan = oldColObj.attr("colspan"), oldRowspan = oldColObj.attr("rowspan");
//add by  2016-02-20
if(col){
var _7aa=_7a7[_7a9];
...
//add by 2016-02-20
var colspan = oldColObj.length && oldColspan != undefined && oldColspan != "" ? "colspan=\"" + oldColspan + "\"" : "";

var rowspan = oldColObj.length && oldRowspan != undefined && oldRowspan != "" ? "rowspan=\"" + oldRowspan + "\"" : "";
//add by  2016-02-20
//cc.push("<td field=\""+_7a9+"\" "+cls+" "+_7ad+">");
cc.push("<td field=\"" + _7a9 + "\" " + cls + " " + _7ad + "" + colspan + "" + "" + rowspan + "" + ">");
var _7ad="";
if(!col.checkbox){
if(col.align){
...
//****************************combox在text里输入汉字没有对应的value的时候,value赋值汉字,提交后天类型转换错误****************
//***************修正为:输入汉字没有对应value,隐藏value赋空值
//_987.val(_983[i]);
if(_985[0].className=="textbox combo"){
	_987.val(_983[i]);
}else if(_983[i]!=""&&_985[0].className=="textbox combo textbox-focused"&&$.data(_982,"combobox")&&"data" in $.data(_982,"combobox")){
	var _777data = $.data(_982,"combobox").data;
	var _777flg=false;
	var _777flg2=false;
	var _777val;
	$.each(_777data, function(n, obj) {
		if(_983[i] == obj[opts.valueField]){
			_987.val(_983[i]);
			_777flg=true;
		}
		if(_983[i] == obj[opts.textField]){
			_777val=obj[opts.valueField];
			_777flg2=true
		}
