...
//====获取LODOP对象的主过程：====
function getLodop(oOBJECT, oEMBED, oIsNeedCLodop) {
    ...
    try {
        ...
        if (oIsNeedCLodop != undefined && oIsNeedCLodop == true) {
            try {
                LODOP = getCLodop();
            } catch(err) {};
        ...
        LODOP.SET_LICENSES("深圳市怡亚通供应链股份有限公司","459717366847573749293799219056","","");
        //===========================================================
        return LODOP;
    } catch(err) {
