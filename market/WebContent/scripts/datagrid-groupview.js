				...
				$.fn.datagrid.defaults.view,
				{
					render : function(target, container, frozen) {
						...
						for (var i = 0; i < groups.length; i++) {
							table.push(this.renderGroup.call(this, target, i,
									groups[i], frozen));
						}
					...
					renderGroup : function(target, groupIndex, group, frozen) {
						...
						var table = [];
						table.push('<div class="datagrid-group" group-index='
								+ groupIndex + '>');
						table
						...
						if (!frozen) {
							...
							table.push(opts.groupFormatter.call(target,
									group.value, group.rows));
							table.push('</span>');
						}
						table.push('</td>');
						table.push('</tr>');
						...
						for (var j = 0; j < group.rows.length; j++) {
							...
							table.push(this.renderRow.call(this, target,
									fields, frozen, index, group.rows[j]));
							table.push('</tr>');
							index++;
						}
						table.push('</tbody></table>');
					...
					expandGroup : function(jq, groupIndex) {
						return jq
								.each(function() {
									...
									var group = view
											.find(groupIndex != undefined ? 'div.datagrid-group[group-index="'
													+ groupIndex + '"]'
													: 'div.datagrid-group');
									var expander = group
...
$.extend(groupview, {
	refreshGroupTitle : function(target, groupIndex) {
		...
		var span = dc.body2.children(
				'div.datagrid-group[group-index=' + groupIndex + ']').find(
	...
	insertRow : function(target, index, row) {
		...
		if (group) {
			...
			$.fn.datagrid.defaults.view.insertRow
					.call(this, target, index, row);
			...
			dc.body1.append(this.renderGroup.call(this, target, groupIndex,
					group, true));
			dc.body2.append(this.renderGroup.call(this, target, groupIndex,
					group, false));
	...
	updateRow : function(target, index, row) {
		...
		var tb = opts.finder.getTr(target, index, 'body', 2).closest(
	...
	deleteRow : function(target, index) {
		...
		if (group.rows.length > 1) {
			...
			body.children('div.datagrid-group[group-index=' + groupIndex + ']')
					.remove();
