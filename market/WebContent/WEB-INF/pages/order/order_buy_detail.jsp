...
<table>
	...
	<tr style="font-weight:bold"><td colspan="6" align="right">金额总计：</td><td align="right">${totalPayment}</td></tr>
...
<script type="text/javascript"> 
	...
	<c:forEach var="dgc" items="${pdiList}">
		drugGiftList.push({pid : "${dgc.pid}" ,giftConfigLineId: "${dgc.giftConfigLineId}" ,payment: "${dgc.payment}",unitPrice: "${dgc.unitPrice}"}) ;
	</c:forEach>
