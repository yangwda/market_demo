...
<script type="text/javascript">
	...
	function saveFeedGoods(){
	      var params = $("#feedGoodInfoForm").serializeArray();
...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',border:false" >
		<form id="feedGoodInfoForm" class="easyui-form" method="post" data-options="">
	...
	<div data-options="region:'south',border:false" style="height:30px" align="center">
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveFeedGoods();" style="width:15%">保存</a>
