...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',border:false" >
		<form id="oncebuyInfoForm" class="easyui-form" method="post" data-options="">
	    	<table cellpadding="5" style="width:100%">
	    		<tr>
	    			<td>单次购买额度起始:</td>
	    			<td><input class="easyui-textbox" type="text" name="beginAmount" data-options="width:345"></input></td>
	    		</tr>
	    		<tr>
	    			<td>单次购买额度结束:</td>
	...
	<div data-options="region:'south',border:false" style="height:30px" align="center">
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveOncebuy();" style="width:15%">保存</a>
